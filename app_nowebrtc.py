...
def main():
    st.set_page_config(page_title="Reconhecimento Facial em Vídeo", layout="wide")
    ...
    cap = cv2.VideoCapture("Matheus.mp4")
    transformer = FaceRecognitionTransformer(config)
    ...
    while cap.isOpened():
            ...
            # Cria VideoFrame do frame
            av_frame = av.VideoFrame.from_ndarray(frame_rgb, format="rgb24")
            processed_frame = transformer.recv(av_frame).to_ndarray(format="bgr24")
